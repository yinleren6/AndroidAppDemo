...
public class Activity_Launch_Mode2 extends AppCompatActivity implements View.OnLongClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Activity_Manger.addActivity(this);
